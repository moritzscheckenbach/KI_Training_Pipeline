...
def get_model(num_classes: int, pretrained: bool = True):
    if pretrained:
        ...
        model = fasterrcnn_resnet50_fpn(
            ...
            min_size=224,
            max_size=512,
            # Use fewer proposals to simulate R-CNN behavior
            rpn_pre_nms_top_n_test=100,
            rpn_post_nms_top_n_test=100,
            box_batch_size_per_image=128,
        )
    else:
        model = fasterrcnn_resnet50_fpn(weights=None, weights_backbone=None, min_size=224, max_size=512, rpn_pre_nms_top_n_test=100, rpn_post_nms_top_n_test=100, box_batch_size_per_image=128)
...
if __name__ == "__main__":
    ...
    print("RCNN_001 Model loaded successfully!")
